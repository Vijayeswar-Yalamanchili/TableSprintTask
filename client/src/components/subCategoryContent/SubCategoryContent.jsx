      ...
      <div className='headerArea d-flex mx-5 my-4'>
        <div className='headerLeft d-flex'>
          <div className='headerCat d-flex'>
            ...
            <p className='mb-0 ms-2' style={{fontSize : "x-large" , width : "8rem"}}>Subcategory</p>  
          </div>
        ...
        <Button style={{backgroundColor : "#5C218B", border : "none"}} onClick={() => navigate('/addSubCategory')}>Add New</Button>
        </div>
      </div>
    </div>
  </>
